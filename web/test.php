    ...
    foreach($movies as $movie){
        ...
        //echo($extra->yt_trailer_code);
            echo ('<div class="movie-image">');
		        echo ('<a class="youtube-link" youtubeid="' .$extra->yt_trailer_code .'" href="#"><span class="play"><span class="name">' .$movie['title'] .'</span></span><img src="' .$movie[cover] .'" alt="movie" /></a>');
	        echo ('</div>');
	        echo ('<div class="rating">');
		        echo ('<div class="stars">');
    			    echo ('<div class="stars-in">');
			        echo ('</div>');
		        echo ('</div>');
		        echo ('<span></span>');
	        echo ('</div>');
