...
function insertMovies($movies) {
	...
	foreach ( $movies as $movie ) {
		...
		echo ('<a class="youtube-link" youtubeid="' . $movie->trailer . '" href="#"><span class="play"></span><img src="' . $movie ['cover'] . '" alt="movie" /></a>');
		echo ('</div>');
